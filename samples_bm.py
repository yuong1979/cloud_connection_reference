...
firestore_db_api_key = access_secret("blockmacro_firebase_db", project_id)
...
firebase_auth_api_key = access_secret("blockmacro_firebase_auth", project_id)
...
google_sheets_api_key = access_secret("blockmacro_googlesheets", project_id)
...
alphavantage_api_key = access_secret("blockmacro_alpha_vantage_api", project_id)
